                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table new-width table-hover table-sm table-bordered p-0" data-page-length="50" style="text-align: center">
                                        <thead>
                                        <tr>
                                            <th class="alert-info">#</th>
                                            <th class="alert-info">{{trans('Students_trans.name')}}</th>
                                            <th class="alert-danger">{{trans('Students_trans.old_grad')}}</th>
                                            <th class="alert-danger">{{trans('Students_trans.academic_year')}}</th>
                                            <th class="alert-danger">{{trans('Students_trans.old_classrom')}} </th>
                                            <th class="alert-danger">{{trans('Students_trans.old_section')}}  </th>
                                            <th class="alert-success">{{trans('Students_trans.new_grad')}}  </th>
                                            <th class="alert-success">{{trans('Students_trans.academic_year_new')}}  </th>
                                            <th class="alert-success">{{trans('Students_trans.new_classrom')}}  </th>
                                            <th class="alert-success">{{trans('Students_trans.new_section')}}  </th>
                                            <th class="alert-secondary">{{trans('Students_trans.Processes')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        @foreach($promotions as $promotion)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#Delete_one{{$promotion->id}}">  {{trans('Students_trans.roll_back_on')}}</button>
