...
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
{{ trans('Students_trans.Add_fee_invoice') }} : {{$student->name}}
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                                    ...
                                    <div data-repeater-list="List_Fees">
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2"> {{ trans('all_trans.Fee_type') }}</label>
                                                    <div class="box">
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2">{{ trans('all_trans.fees') }}</label>
                                                    <div class="box">
                                                ...
                                                <div class="col">
                                                    <label for="description" class="mr-sm-2">{{ trans('all_trans.Statement') }}</label>
                                                    <div class="box">
