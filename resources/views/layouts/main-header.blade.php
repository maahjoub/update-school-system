<!--=================================
header start-->
<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 d-flex flex-row fixed-top">
    <!-- logo -->
    <div class="text-left navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{ url('/dashboard') }}">
            @if (App::getLocale() == 'ar')
            <img src="{{ URL::asset('assets/images/school-logo.png') }}" alt="">
            @else
                <img src="{{ URL::asset('assets/images/school-en.png') }}" alt="">
            @endif
        </a>
    ...
    <ul class="nav navbar-nav ml-auto nav-ul">
        ...
        <div class="btn-group mb-1 rtl-fix">
            <button type="button" class="btn btn-light btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              @if (App::getLocale() == 'ar')
              {{ LaravelLocalization::getCurrentLocaleName() }}
             <img class="rlt-fix-img" src="{{ URL::asset('assets/images/flags/SD.png') }}" alt="">
              @else
              {{ LaravelLocalization::getCurrentLocaleName() }}
              <img class="rlt-fix-img" src="{{ URL::asset('assets/images/flags/GB.png') }}" alt="">
              @endif
              </button>
