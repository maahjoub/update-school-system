...
class AddParent extends Component
{
    ...
    public $catchError,$photos, $updateMode = false, $show_table = true, $Parent_id;
    ...
    public function updated($propertyName)
    {
        $this->validateOnly($propertyName, [
            ...
            'National_ID_Father' => 'required|string|min:10|max:11|regex:/[0-9]{9}/',
            'Passport_ID_Father' => 'min:10|max:11',
        ...
        try {
            ...
            if(!empty($this->photos))
            {
                foreach($this->photos as $file)
                {
                    ...
                    $file->storeAs('attachments/paernt/' . $My_Parent->Name_Father, $file->getClientOriginalName(),'upload_attachments');
            ...
            //         $photo->storeAs('attachments/parents/'.$My_Parent->Name_Father , $photo->getClientOriginalName(), $disk = 'upload_attachments');
